...
const RegisterBusiness = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form
        onSubmit={onSubmit}
        className="flex flex-col gap-5 p-8 rounded-lg shadow w-full max-w-md gradient"
      >
        <h1 className={`${nunito.className} text-3xl md:text-4xl font-black`}>
          {verificationStep ? "Verificar Código" : "Crear cuenta"}
        </h1>
          ...
          <>
            ...
            <div className="flex items-center border p-2 gap-2 rounded-lg">
              ...
              <input
                type="text"
                name="addressLine"
                value={formData.userConfiguration.address.addressLine}
