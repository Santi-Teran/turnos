...
const Servicios = () => {
  return (
    <div>
      <NavBar />
      <div className="flex flex-col items-center pt-32 pb-10 gap-10">
        <h1 className="text-2xl md:text-5xl text-verde-agua font-black">Nuestros Servicios</h1>
        <h2 className={`${nunito.className} text-lg md:text-3xl text-center font-semibold mx-4 md:mx-32`}>Descubre cómo podemos ayudarte a destacar en el mundo digital con un trato cercano y personalizado</h2>
