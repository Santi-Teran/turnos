...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center my-10 gap-5 md:gap-10 bg-dark-blue dark:bg-arena text-arena dark:text-dark-blue mx-4 md:mx-20 p-6 md:p-12 rounded-3xl'>
