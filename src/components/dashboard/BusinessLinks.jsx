...
const BusinessLinks = () => {
  ...
  return (
    <ul className="flex gap-10">
      ...
      <Link className={isActive('/dashboard/negocio/perfil') ? 'text-cyan-500 font-bold border-b-2 border-cyan-500' : 'text-gray-400'} href='/dashboard/negocio/perfil'>Perfil</Link>
    </ul>
  )
}
