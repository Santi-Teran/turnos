    ...
    <div className="flex flex-col items-center gap-20 mx-4 md:mx-40">
      <div className="flex flex-col lg:flex-row justify-center gap-10 lg:gap-40">
        <div className="lg:w-1/2 flex flex-col gap-10">
          <h1 className="text-2xl md:text-4xl text-verde-agua font-black">Trabajemos Juntos!</h1>
          ...
          <ul className="flex flex-col gap-4 md:gap-10">
            <li className="flex items-center gap-2"><MdMailOutline className="text-lg md:text-xl text-verde-agua" />info@mareatech.com</li>
            <li className="flex items-center gap-2"><BiBuildingHouse className="text-lg md:text-xl text-verde-agua" /></li>
            <li className="flex items-center gap-2"><BiPhone className="text-lg md:text-xl text-verde-agua" />+54 223 1111111</li>
          </ul>
        </div>
